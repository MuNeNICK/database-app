...
const PostBody = ({ content, slug }: Props) => {
  ...
  return (
    <div className="xl:grid grid-cols-4 gap-4 pb-32">
      <div className="max-w-4xl mx-auto col-span-3 bg-white xl:w-screen p-10 rounded-xl shadow">
        <div
          className={markdownStyles['markdown']}
        >{component}</div>
      </div>
      <div className="hidden xl:block mx-auto col-span-1 bg-white w-full h-max rounded-xl p-2 sticky top-40  shadow">
